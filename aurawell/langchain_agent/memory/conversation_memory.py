    ...
    async def get_relevant_context(
        ...
        try:
            ...
            for conversation in recent_history:
                ...
                # 简单的关键词匹配
                if (query_lower in user_msg or 
                    query_lower in ai_msg or
                    any(word in user_msg or word in ai_msg for word in query_lower.split())):
