...
class AuraWellSettings:
    ...
    DEEPSEEK_DEFAULT_MODEL: str = os.getenv("DEEPSEEK_DEFAULT_MODEL", "deepseek-reasoner")
...
RECOMMENDATION_CONFIG = {
    ...
    "category_distribution": {"activity": 0.4, "nutrition": 0.3, "sleep": 0.2, "stress": 0.1},
}
...
GAMIFICATION_CONFIG = {
    ...
    "badge_thresholds": {
        ...
        "consistency": {"bronze": 3, "silver": 7, "gold": 14, "platinum": 30},  # days in a row
