...
def get_download_path():
    """
    获取下载路径，返回项目根目录下的nutrition_article文件夹
    ...
    try:
        ...
        # 构建下载路径
        download_path = os.path.join(project_root, 'nutrition_article')
        ...
        print(f"获取下载路径失败: {e}")
        # 回退到当前目录下的nutrition_article
        fallback_path = os.path.join(os.getcwd(), 'nutrition_article')
