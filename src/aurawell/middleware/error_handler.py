...
class ValidationException(AuraWellException):
    ...
    def __init__(self, message: str, field: str = None, value: Any = None):
        details = create_error_details(
            ErrorCode.INVALID_INPUT, field=field, value=value
        )
        super().__init__(
            message=message,
...
class AuthenticationException(AuraWellException):
    ...
    def __init__(
        self, message: str = None, error_code: ErrorCode = ErrorCode.UNAUTHORIZED
    ):
        super().__init__(
...
async def aurawell_exception_handler(
    request: Request, exc: AuraWellException
) -> JSONResponse:
    ...
    error_response = ErrorResponse(
        message=exc.message, error_code=exc.error_code.value, details=exc.details
    )
...
async def validation_exception_handler(
    ...
    error_response = ErrorResponse(
        ...
        details={"path": str(request.url.path), "validation_errors": errors},
    )
...
async def general_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    ...
    error_response = ErrorResponse(
        ...
        details={"path": str(request.url.path), "exception_type": type(exc).__name__},
    )
